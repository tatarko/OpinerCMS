...
function Texyla (options) {
	...
	this.lng = typeof(options.lng) === 'string' ? Texyla.lng[options.lng] : Texyla.lng.sk;
...
Texyla.toolbars = {
	...
	admin: [
		...
		'comment',
		null,
		['div', 'code', 'inlineCode', 'html', 'notexy']
	],
	// forum lišta
	forum: [
		'bold', 'italic', null, 'ul', 'ol', null, 'link', null, 'emoticon'
	],
...
Texyla.lng = {
			...
			btn_left: "Zarovnať doľava",
			btn_right: "Zarovnať doprava",
			btn_justify: "Zarovnať podľa okraja",
			btn_ul: "Zoznam",
			...
			texy_acronym_title: "Titulok",

			// náhľady
			view_edit: "Upraviť",
			view_preview: "Náhľad",
			view_html: "HTML",
			view_syntax: "Texy syntaxa",
			view_wait: "Prosím čakajte",
			view_empty: "Textové pole je prázdne!",
			view_submit: "Odoslať",

			// obrázok
			img_heading: "Vložiť obrázok",
			img_src: "Adresa obrázku",
			img_alt: "Popis",
			img_align: "Zarovnanie",
			img_al_none: "žiadne",
			img_al_left: "vľavo",
			img_al_right: "vpravo",
			img_al_center: "centrovať",
			img_descr: "Zobraziť ako popis",

			// tabuľka
			tab_heading: "Vložiť tabuľku",
			tab_cols: "Počet stĺpcov",
			tab_rows: "Počet riadkov",
			tab_th: "Hlavička",
			tab_th_none: "žiadne",
			tab_th_top: "hore",
			tab_th_left: "vľavo",
			...
			// smajlíci
			emoticon_heading: "Vložiť smajlíka",

			// symboly
			symbol_heading: "Vložiť symbol",
